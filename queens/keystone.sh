...
keystone-manage bootstrap --bootstrap-password $PASSWORD \
  --bootstrap-admin-url http://$C_IP:5000/v3/ \
  --bootstrap-internal-url http://$C_IP:5000/v3/ \
...
export OS_AUTH_URL=http://$C_IP:5000/v3
...
echo "export OS_AUTH_URL=http://$C_IP:5000/v3" >> admin-openrc.sh
